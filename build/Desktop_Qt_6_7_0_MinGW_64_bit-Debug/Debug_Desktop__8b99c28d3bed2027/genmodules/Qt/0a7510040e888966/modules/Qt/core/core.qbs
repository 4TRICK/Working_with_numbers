...
Module {
    ...
    property path binPath: "A:/qt/6.7.0/mingw_64/bin"
    property path installPath: "A:/qt/6.7.0/mingw_64/bin"
    property path incPath: "A:/qt/6.7.0/mingw_64/include"
    property path libPath: "A:/qt/6.7.0/mingw_64/lib"
    property path installPrefixPath: "A:/qt/6.7.0/mingw_64"
    property path libExecPath: "A:/qt/6.7.0/mingw_64/bin"
    property path qmlLibExecPath: "A:/qt/6.7.0/mingw_64/bin"
    property path pluginPath: "A:/qt/6.7.0/mingw_64/plugins"
    property string mkspecName: "win32-g++"
    property path mkspecPath: "A:/qt/6.7.0/mingw_64/mkspecs/win32-g++"
    ...
    property path docPath: "A:/qt/Docs/Qt-6.7.0"
    property string helpGeneratorLibExecPath: "A:/qt/6.7.0/mingw_64/bin"
    ...
    property string libFilePathRelease: "A:/qt/6.7.0/mingw_64/lib/libQt6Core.a"
    ...
    cpp.systemIncludePaths: ["A:/qt/6.7.0/mingw_64/include","A:/qt/6.7.0/mingw_64/include/QtCore"].concat(mkspecPath)
    cpp.libraryPaths: {
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? undefined : ["A:/qt/6.7.0/mingw_64/lib/libQt6EntryPoint.a"]);
        }
